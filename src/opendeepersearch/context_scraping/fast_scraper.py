...
from opendeepersearch.context_scraping.utils import clean_html, get_wikipedia_content
        ...
        try:
            ...
            if "wikipedia.org/wiki/" in url:
                try:
                    ...
                    return ExtractionResult(name="llm_extraction", success=True, content=content)
            ...
            if not result.success:
                return ExtractionResult(name="llm_extraction", success=False, error="Failed to fetch HTML")
            ...
            if self.debug:
                ...
                print("Debug: Exception during scraping:")
                print(traceback.format_exc())

            return ExtractionResult(name="llm_extraction", success=False, error=str(e))
